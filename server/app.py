...
"""
FastAPI application for the Llm Reward Lab Environment.

This module creates an HTTP server that exposes the LlmRewardLabEnvironment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m llm_reward_lab.server.app
    ...
    multiple workers:
        uvicorn llm_reward_lab.server.app:app --workers 4
    """
    import uvicorn
